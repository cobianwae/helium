...
jQuery(document).ready(function($){
    ...
    $(document.body).on('click', '.video-button, .image-button, .audio-button', function(e){
        // Prevent the default action from occuring.
        e.preventDefault();

        var avideo = $(this).hasClass('video-button');
        var aauido = $(this).hasClass('audio-button');
        var type = 'image';
        var $trigger = $(this);
        if(avideo){
            type = 'video';
     ...
     $(document.body).on('click', '.remove-button',function(e){
        $(this).prev().prev().val('');
